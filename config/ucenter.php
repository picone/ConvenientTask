...
return [
     ...
     * 用户删除 API 接口开关
     */
    'api_deleteuser' => env('UC_API_DELETEUSER',0),

    /*
     * 用户改名 API 接口开关
     */
    'api_renameuser' => env('UC_API_RENAMEUSER',0),

    /*
     * 获取标签 API 接口开关
     */
    'api_gettag' => env('UC_API_GETTAG',0),
     ...
     * 更改用户密码 开关
     */
    'api_updatepw' => env('UC_API_UPDATEPW',0),

    /*
     * 更新关键字列表 开关
     */
    'api_updatebadword' => env('UC_API_UPDATEBADWORDS',0),
     ...
     * 更新用户积分 开关
     */
    'api_updatecredit' => env('UC_API_UPDATECREDIT',0),

    /*
     * 向 UCenter 提供积分设置 开关
     */
    'api_getcreditsettings' => env('UC_API_GETCREDITSETTINGS',0),
     ...
     * 更新应用积分设置 开关
     */
    'api_updatecreditsettings' => env('UC_API_UPDATECREDITSETTINGS',0),
